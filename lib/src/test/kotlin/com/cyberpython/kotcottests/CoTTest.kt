...
class CoTTest {
    ...
    @Test fun xmlToBaseEvent() {
        ...
        assertEquals(ZonedDateTime.parse("2022-08-19T16:09:11.128558Z"), evt.time)
        assertEquals(ZonedDateTime.parse("2022-08-19T16:09:11.130456Z"), evt.start)
        assertEquals(ZonedDateTime.parse("2022-08-19T16:19:11.130479Z"), evt.stale)
